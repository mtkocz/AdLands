...
class TuskGlobalChat {
  constructor(io, roomId, room) {
    ...
    this.templates = {
      ...
      clusterCapture: [
        "{faction} just took the {cluster} territory. Someone's getting a promotion.",
        "{faction} conquered {cluster}. The sponsor will be pleased. Probably.",
        "{faction} claims {cluster} territory! That's the kind of initiative I pretend to reward.",
        "The {cluster} territory falls to {faction}. Previous owners: skill issue.",
        "{faction} locked down {cluster}. Revenue is flowing. To me, obviously.",
      ],
      territoryRent: [

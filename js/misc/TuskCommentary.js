...
const TUSK_LINES = {
  ...
  tips_and_tricks: [
    ...
    "Pro tip: Switch to faction chat before sharing your battle plan. Global chat is... public. The enemy can read.",
    "Tip: Squad up with nearby teammates. Two tanks pushing one hex is math. One tank pushing alone is a funeral.",
    "Here's a thought: Call out enemy positions in faction chat. Your teammates can't read your mind. Yet.",
    "Quick tip: Coordinated pushes win wars. Charge in alone and you're content, not a conqueror.",
    "Tip: If you see a teammate fighting, join them. Teamwork doubles your firepower and halves your clone bill.",
    "Pro tip: Use faction chat to call for backup. Dying silently is noble but stupid. Mostly stupid.",
    "Tip: Squading up near portals lets you reinforce each other fast. Logistics wins wars. I read that somewhere.",
    "Here's wisdom: A coordinated two-tank push is worth more than five solo heroes feeding the enemy killstreaks.",
    "Quick tip: Faction chat is for strategy. Global chat is for trash talk. Know the difference.",
    "Pro tip: Ping your position when you need help. Teammates can't help what they can't see.",
    // New player specific
